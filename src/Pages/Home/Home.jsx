...
const wordArray4 = [
    'Copies of the Prospectus can be downloaded from the college website www.travancoremedicity.com. at free of cost. Copies of the same will also be available at the Administrative Office of Travancore College of Allied Health Sciences (TCAHS), Kollam for reference and return.'
]
const Home = () => {
